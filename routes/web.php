...
Route::get('/Services/{idCategorie}', $controller_path.'\services\Services@getServiceByIdCategorie')->name('services-by-category');
...
// categories
Route::get('/categories', $controller_path.'\Categorie\CategoryController@index')->name('all-categories');
