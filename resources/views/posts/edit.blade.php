...
@section("content")
	...
	@endif
		...
		<p>
			...
			<input type="text" name="title" class="form-control" value="{{ isset($post->title) ? $post->title : old('title') }}"  id="title" placeholder="Le titre du post" >
		...
		<p>
			...
			<textarea name="content"  class="form-control" id="content" lang="fr" rows="10" cols="50" placeholder="Le contenu du post" >{{ isset($post->content) ? $post->content : old('content') }}</textarea>
